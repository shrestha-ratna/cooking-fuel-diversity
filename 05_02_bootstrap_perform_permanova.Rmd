...
knit: (function(input_file, encoding) {
 ...
 encoding=encoding,
 output_file=file.path(dirname(input_file), out_dir, '05_02_bootstrap_permanova.html'))})
---
...
getPermanova <- function(dat){
     ...
     # PERMANOVA TEST ---
     set.seed(12345)
     y_permanova <- vegan::adonis(dist_dml ~ IncomeGroup+Ethnicity+EducationLevel+GeoRegion, data=dat, permutations=999, method="euclidean", parallel=8)
