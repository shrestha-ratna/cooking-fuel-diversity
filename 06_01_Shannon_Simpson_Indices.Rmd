...
knit: (function(input_file, encoding) {
 ...
 encoding=encoding,
 output_file=file.path(dirname(input_file), out_dir, '06_01_Shannon_Simpson_Index.html'))})
---
...
```{r}
pairwise.wilcox.test(x=dat$SimpsonIndex, g=dat$Ethnicity, p.adjust.method="bonferroni", paired=FALSE, exact=FALSE)